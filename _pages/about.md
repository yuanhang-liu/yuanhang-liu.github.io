...
My interest focuses on the intersection of  and Natural Language Processing, with the goal of building accurate and efficient systems (e.g. question answering) that enable individuals to access the most up-to-date knowledge in real-world scenarios. My research spans across building large-scale retrieval-augmented language models, developing more generalizable open domain QA systems, and interpreting model behavior.
